...
import Apartcard3 from './IMAGES/Apartcard3.jpg';
import Apartcard4 from './IMAGES/Apartcard4.jpg';
...
<div className="carousel-inner rounded-4" >
  ...
  <div className='row bg-light rounded'>
          <img src={Apartcard3} alt="Apartcard3" className='col-12 col-sm-12 col-md-6 col-lg-6 p-0 ' />
          ...
          <div className="col-12 col-sm-12 col-md-6 col-lg-6 mx-auto my-auto p-5">
             ...
             <h3 className='margin'>Food First Page</h3>
  ...
  <div className='row bg-light rounded'>
          <img src={Apartcard4} alt="Apartcard4" className='col-12 col-sm-12 col-md-6 col-lg-6 p-0 ' />
          ...
          <div className="col-12 col-sm-12 col-md-6 col-lg-6 mx-auto my-auto p-5">
             ...
             <h3 className='margin'>Food Second Page</h3>
             <p className='margin'style={{color:"grey"}}>by: Sale Agent</p>
             <div >
                <span className='me-2'><i class="fa-solid fa-money-check-dollar"></i></span>
