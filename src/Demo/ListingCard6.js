...
export default function ListingCard6() {
  return (
    <div className='mt-4'>
...
<div className="carousel-indicators ">
  <button type="button" data-bs-target="#demo5" data-bs-slide-to="0" className="active" ></button>
...
<div className="carousel-inner rounded-4" >
  ...
  <div className='row bg-light rounded'>
          ...
          <div className="col-12 col-sm-12 col-md-6 col-lg-6 mx-auto my-auto p-5">
             ...
             <h3 className='margin'>Car Item 2</h3>
  ...
  <div className='row bg-light rounded'>
          ...
          <div className="col-12 col-sm-12 col-md-6 col-lg-6 mx-auto my-auto p-5">
             ...
             <h3 className='margin'>Car Item 4</h3>
             <p className='margin'style={{color:"grey"}}>by: Sale Agent</p>
             <div >
                <span className='me-2'><i class="fa-solid fa-money-check-dollar"></i></span>
