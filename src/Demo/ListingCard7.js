...
export default function ListingCard7() {
  return (
    <div className='mt-1'>
      <div id="demo6" className="carousel slide " data-bs-ride="carousel">

  
<div className="carousel-indicators ">
  <button type="button" data-bs-target="#demo6" data-bs-slide-to="0" className="active" ></button>
...
<div className="carousel-inner rounded-4" >
  ...
  <div className='row bg-light rounded'>
          <img src={card5} alt="card5" className='col-12 col-sm-12 col-md-6 col-lg-6 p-0 ' />
          ...
          <div className="col-12 col-sm-12 col-md-6 col-lg-6 mx-auto my-auto p-5">
             ...
             <h3 className='margin'>4th Category Second Page</h3>
  ...
  <div className='row bg-light rounded'>
          <img src={card6} alt="card6" className='col-12 col-sm-12 col-md-6 col-lg-6 p-0 ' />
